...
function Scene({ portal, ...props }) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <Clone object={nodes['Bubble-BG']} scale={1.5} />
      <FloatImpl floatIntensity={100} rotationIntensity={0.5} speed={1}>
        ...
        <group position={[0, -50, 0]} rotation={[-0.15, 0, 0]}>
          ...
          <group name="phone" position={[-50, 0, -68]} scale={1.25}>
            <Clone object={[nodes['Rectangle 4'], nodes['Rectangle 3'], nodes['Boolean 2']]} scale={1} />
